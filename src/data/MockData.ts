...
const Columns = signal([
	{ name: "To Do", id: 1, taskId:["Task Example 1", "Task Example 2", "Task Example 3", "Task Example 4", "Task Example 5"] },
	{ name: "In Progress", id: 2, taskId:["Task Example 6", "Task Example 7", "Task Example 8"]},
	{ name: "Completed", id: 3, taskId:["Task Example 9", "Task Example 10", "Task Example 11", "Task Example 12", "Task Example 13"] },
]);
